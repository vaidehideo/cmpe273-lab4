...
public class DistributedCacheService implements CacheServiceInterface {
    ...
    public DistributedCacheService(String serverUrl, CRDTClass crdt) {
        this.cacheServerUrl = serverUrl;
        this.crdt = crdt;
    }
        ...
        Future<HttpResponse<JsonNode>> future = Unirest.get(this.cacheServerUrl + "/cache/{key}")
                ...
                .asJsonAsync(new Callback<JsonNode>() {
                    ...
                    public void failed(UnirestException e) {
                        ...
                        crdt.readMap.put(cacheServerUrl, "fail");
                    }
                    ...
                    public void completed(HttpResponse<JsonNode> response) {
                        if (response.getCode() != 200) {
                            ...
                            crdt.readMap.put(cacheServerUrl, value);
                        }
                    }
        ...
        Future<HttpResponse<JsonNode>> future = Unirest.put(this.cacheServerUrl + "/cache/{key}/{value}")
                ...
                .asJsonAsync(new Callback<JsonNode>() {
                    ...
                    public void failed(UnirestException e) {
                        ...
                        crdt.writeMap.put(cacheServerUrl, "fail");
                    }
                    ...
                    public void completed(HttpResponse<JsonNode> response) {
                        if (response == null || response.getCode() != 200) {
                            ...
                            crdt.writeMap.put(cacheServerUrl, "pass");
                        }
                    }
